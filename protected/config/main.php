	...
	'components'=>array(
		...
		'urlManager'=>array(
			...
			'rules'=>array(
				...
				'/blog/tag/<tag:[a-zA-Z0-9&_\.-]+>/<year:[0-9]+>/<month:[0-9]+>/page-<page:[0-9]+>.html'=>'blog/index',
				'/blog/tag/<tag:[a-zA-Z0-9&_\.-]+>/<year:[0-9]+>/<month:[0-9]+>/<slug:[a-zA-Z0-9&_\.-]+>.html'=>'blog/detail',
				'/blog/tag/<tag:[a-zA-Z0-9&_\.-]+>/<year:[0-9]+>/<month:[0-9]+>'=>'blog/index',

				'/blog/tag/<tag:[a-zA-Z0-9&_\.-]+>/page-<page:[0-9]+>.html'=>'blog/index',
				'/blog/tag/<tag:[a-zA-Z0-9&_\.-]+>/<slug:[a-zA-Z0-9&_\.-]+>.html'=>'blog/detail',
				'/blog/tag/<tag:[a-zA-Z0-9&_\.-]+>/'=>'blog/index',
				
				'/blog/<year:[0-9]+>/<month:[0-9]+>/page-<page:[0-9]+>.html'=>'blog/index',
				'/blog/<year:[0-9]+>/<month:[0-9]+>'=>'blog/index',
				'/blog/<year:[0-9]+>/<month:[0-9]+>/<slug:[a-zA-Z0-9&_\.-]+>.html'=>'blog/detail',

				'/blog/page-<page:[0-9]+>.html'=>'blog/index',
				'/blog/'=>'blog/index',
