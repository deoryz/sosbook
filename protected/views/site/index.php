    <div class="slider-bootstrap"><!-- start slider -->
    	<div class="slider-wrapper theme-default">
            <div id="slider-nivo" class="nivoSlider">
                <img src="<?php echo Yii::app()->baseUrl;?>/asset/hebo/img/slider/flickr/s10.jpg" data-thumb="<?php echo Yii::app()->baseUrl;?>/asset/hebo/img/slider/flickr/s10.jpg" alt="" title="" />
                <img src="<?php echo Yii::app()->baseUrl;?>/asset/hebo/img/slider/flickr/s11.jpg" data-thumb="<?php echo Yii::app()->baseUrl;?>/asset/hebo/img/slider/flickr/s11.jpg" alt="" title="" />
            </div>
        </div>
