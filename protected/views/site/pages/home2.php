    <div class="slider-bootstrap"><!-- start slider -->
    	...
    	<div id="myCarousel" class="carousel slide" style="min-height:430px;">
          ...
          <div class="carousel-inner">
            <div class="active item" style="min-height:430px;">
       	    	<img src="<?php echo Yii::app()->baseUrl;?>/asset/hebo/img/slider/flickr/s10.jpg" width="1000" height="430" />
            
            </div>
            
            <div class="item" style=" min-height:430px;">
            	<img src="<?php echo Yii::app()->baseUrl;?>/asset/hebo/img/slider/flickr/s11.jpg" width="1000" height="430" />
            </div>
          </div>
          <!-- Carousel nav -->
        ...
        <div class="span3">
          ...
          <div class="span3">
            ...
            <div class="colored_banner thumb-content-dark">
            <img src="<?php echo Yii::app()->baseUrl;?>/asset/hebo/img/simpson3.jpg" width="260" height="180" />
            <h3>
            Chris Dolor
            </h3>
